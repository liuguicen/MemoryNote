...
interpretatio		int?:pri’tei??n       n.解释；口译
...
recommendatio		rek?men’dei??n       n.推荐，介绍；劝告
...
representativ		repri’zent?tiv       a.代表性的 n.代表
...
thereby		ad.因此，从而，由此
therefore		ad.因此，所以【绝对不可以直接连接两个独立的句子】
...
transformatio		tr?nsf?’mei??n       n.变化；改造；转变
...
transportatio		tr?nsp?:’tei??n       n.运输，运送，客运
trap		n.陷阱；诡计 vt.诱骗
tray		n.(浅)盘，托盘，碟
